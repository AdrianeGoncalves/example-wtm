package com.wtm.examplewtmkotlinspring.controller

import com.wtm.examplewtmkotlinspring.model.Article
import com.wtm.examplewtmkotlinspring.repository.ArticleRepository
...
class ArticleController(private val articleRepository: ArticleRepository) {
    ...
    fun createNewArticle(@Valid @RequestBody article: Article) = articleRepository.save(article)
